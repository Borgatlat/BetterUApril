-- Create a function to award Sparks to users
-- This function can be called from the client to award Sparks immediately when a referral code is used
...
DECLARE
    ...
    v_result JSONB;
BEGIN
    -- Award 3 Sparks to the referrer
    UPDATE profiles 
    ...
    -- Award 3 Sparks to the referred user
    UPDATE profiles 
    SET sparks_balance = COALESCE(sparks_balance, 0) + 3
