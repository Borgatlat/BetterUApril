...
CREATE TABLE notifications (
    ...
    data JSONB DEFAULT '{}'::jsonb, -- Store additional data like post_id, user_id, etc.
    is_read BOOLEAN DEFAULT false,
    is_actionable BOOLEAN DEFAULT true, -- Whether user can interact with this notification
    action_type VARCHAR(50), -- 'navigate', 'accept', 'decline', 'view', etc.
    action_data JSONB DEFAULT '{}'::jsonb, -- Data needed for the action
    priority INTEGER DEFAULT 1 CHECK (priority IN (1, 2, 3)), -- 1=low, 2=medium, 3=high
    expires_at TIMESTAMP WITH TIME ZONE, -- When notification should be auto-deleted
